package movies.test.softserve.movies.constans;
...
public interface Constants {
    ...
    String LIKE = "%";
    String REDIRECT_URI = "?redirect_to=movieapp://callback";
    String AUTHENTICATE = "https://www.themoviedb.org/authenticate/";
}
